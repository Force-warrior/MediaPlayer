                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MEDIAPLAYER, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MEDIAPLAYER));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MEDIAPLAYER);
...
void onCreateMainWindow(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
	CreateWindowEx(0, TEXT("BUTTON"), TEXT("SDL PlayVideo"), WS_VISIBLE | WS_CHILD ,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        break;
	case WM_CREATE:
		onCreateMainWindow(hWnd, message, wParam, lParam);
		break;
    case WM_PAINT:
        {
            PAINTSTRUCT ps;
